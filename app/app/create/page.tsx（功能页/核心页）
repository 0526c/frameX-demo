              ...
              >
                ...
                <div className="flex-1 flex flex-col gap-4">
                  ...
                  <motion.button
                    ...
                    className="w-full py-4 bg-gradient-to-r from-gold to-gold-bright rounded-xl font-semibold text-void flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
